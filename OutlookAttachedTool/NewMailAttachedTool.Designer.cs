...
{
	partial class NewMailAttachedTool : Microsoft.Office.Tools.Ribbon.RibbonBase
	{
		/// <summary>
		/// デザイナー変数が必要です。
		/// </summary>
		...
		private void InitializeComponent()
		{
            ...
            // group2
            // 
            this.group2.Items.Add(this.t_sp_urlDecode);
            this.group2.Items.Add(this.bt_opneTemp);
            this.group2.Label = "その他";
            ...
            this.t_sp_urlDecode.Click += new Microsoft.Office.Tools.Ribbon.RibbonControlEventHandler(this.bt_sp_urlDecode_Click);
            // 
            // bt_opneTemp
            // 
	...
	{
		internal NewMailAttachedTool Ribbon2
		{
			get { return this.GetRibbon<NewMailAttachedTool>(); }
		}
	}
}
